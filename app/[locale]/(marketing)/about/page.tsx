...
export const metadata: Metadata = {
  title: "About | Paxora Parish OS",
  description: "Mission and story behind Paxora Parish OS.",
  openGraph: { title: "About | Paxora Parish OS", images: ["/og/marketing-default.svg"] },
