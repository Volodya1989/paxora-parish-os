            ...
            <div className="mt-1 flex flex-wrap items-center gap-1">
              {reactions.map((reaction) => (
                <button
                  ...
                  type="button"
                  className={cn(
                    "inline-flex items-center gap-1 rounded-full border px-1.5 py-0 text-xs shadow-sm",
                ...
                >
                  <span aria-hidden="true" className="text-[1.05rem] leading-none">{reaction.emoji}</span>
