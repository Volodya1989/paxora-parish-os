...
export function UsersIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M3.5 19c0-2.5 3-4 4.5-4s4.5 1.5 4.5 4" />
      <path d="M11 19c0-2.1 2.6-3.6 4-3.9 1.4-.3 5 1.1 5 3.9" />
    </svg>
  );
}
...
export function HandHeartIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 20s-6.5-4.4-6.5-8.6A3.9 3.9 0 0 1 12 9.4a3.9 3.9 0 0 1 6.5 2c0 4.2-6.5 8.6-6.5 8.6z" />
      <path d="M16 6.5c.6-1.3 2.2-2 3.7-1.4 1.5.6 2.1 2.5 1.2 4" />
    </svg>
  );
}
...
export function SparklesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M6 15l.8 1.8L9 18l-2.2 1.2L6 21l-.8-1.8L3 18l2.2-1.2L6 15z" />
    </svg>
  );
}
...
export function MassTimesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function ConfessionIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function ReadingsIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M4 4.5c0-1.1.9-2 2-2h3a2 2 0 0 1 2 2V20a2 2 0 0 0-2-2H4.5A.5.5 0 0 1 4 17.5v-13Z" />
      <path d="M20 4.5c0-1.1-.9-2-2-2h-3a2 2 0 0 0-2 2V20a2 2 0 0 1 2-2h5.5a.5.5 0 0 0 .5-.5v-13Z" />
    </svg>
  );
}

export function GivingIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 21s-6-4-6-8.5a3.5 3.5 0 0 1 6-2.5 3.5 3.5 0 0 1 6 2.5c0 4.5-6 8.5-6 8.5z" />
      <path d="M12 5V3" />
      <path d="M6.5 8.5L5 7" />
...
export function PrayerIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 2v4" />
      <path d="M6.8 6.8l2.9 2.9" />
      <path d="M2 12h4" />
      <path d="M12 22s-4-2.5-4-6V9l4-2 4 2v7c0 3.5-4 6-4 6z" />
    </svg>
  );
}
